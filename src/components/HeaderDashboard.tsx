  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1">
        <h3 className="text-[14px] font-semibold ">Bienvenue Diano</h3>
      ...
      <MenuList className="flex flex-col items-center gap-4 relative">
        <MenuItem className="">
          <div className=" pointer-cursor">
            <Typography variant="h6" color="blue-gray" className="text-[16px] font-semibold">
              Notifications
            </Typography>
          </div>
        </MenuItem>
        <MenuItem className="flex items-center gap-4 py-2 pl-2 pr-8">
          <Avatar className=" cursor-pointer" src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1480&q=80" size="sm" variant="circular"/>
          <div className="flex flex-col gap-1">
            <h3 className="text-[14px] font-semibold text-black">Nouvelle candidature</h3>
            <p className="text-[12px] font-normal text-[#75767C]">
              Lundi, Juillet 3, 2025
            </p>
          </div>
    ...
    <Menu placement="bottom-end"
      ...
      <MenuList>
        <MenuItem className="flex items-center gap-2 py-2 pl-2 pr-8">
          <CgProfile size={15}/>
          <Typography variant="small" className="font-medium">Profil</Typography>
        </MenuItem>
        <hr className="my-3"/>
